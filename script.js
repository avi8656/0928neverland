...
function menu(){
    ...
    .addEventListener("click",function(){
        if(flag === 0){
        document.querySelector("#ham>.line:nth-child(1)").style.transform = `rotate(45deg)`
        document.querySelector("#ham>.line:nth-child(2)").style.transform = `rotate(-45deg) translateY(-10px) translateX(10px)`
        document.querySelector("#ham>.line:nth-child(1)").style.backgroundColor = "black"
        document.querySelector("#ham>.line:nth-child(2)").style.backgroundColor = "black"
    ...
    flag= 1
            ...
            document.querySelector("#ham>.line:nth-child(1)").style.transform = `rotate(0deg)`
            document.querySelector("#ham>.line:nth-child(2)").style.transform = `rotate(0deg) translateY(0px) translateX(0px)`
            document.querySelector("#ham>.line:nth-child(1)").style.backgroundColor = "white"
            document.querySelector("#ham>.line:nth-child(2)").style.backgroundColor = "white"
...
// var cur = document.querySelector("#cursor")
// var h1 = document.querySelector("#left")
...
//     cur.style.width = "20px"
// })
// h1.document.querySelector("mouseenter",function(){
//     cur.style.transform="scale5"
...
function txt(){
 ...
 var clutter = "";
    document.querySelector("#txt >h1").textContent.split("").forEach(function(char){
...
var clutter1 = "";
    document.querySelector("#txt h2").textContent.split("").forEach(function(char){
        clutter +=`<span> ${char} </span>`
    })
document.querySelector("#txt h2").innerHTML = clutter
...
function pg(){
    gsap.to("#texto",{
        ...
        function pg6(){
            var clut = "";
            document.querySelector("#pg6>h1").textContent.split("")
            .forEach(function(tex){
                clut += `<span>${tex}</span>`
            })
            document.querySelector("#pg6>h1").innerHTML = clut
